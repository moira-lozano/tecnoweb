...
// al eliminar, refrescamos lista
const onDeleteSuccess = (e) => {
  console.log(e);
  series.value = e.props.series.data;
};

// Datos de series
const seriesData = ref(page.props.series || {});
const series = ref(seriesData.value.data || []);
const currentPage = ref(seriesData.value.current_page || 1);
const lastPage = ref(seriesData.value.last_page || 1);
...
const visiblePages = computed(() => {
  ...
  return seriesData.value.links.filter((link) => {
                ...
                <div class="box box-default border border-gray-800">
                  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 p-2">
                    <div class="overflow-auto">
                      <table class="table table-bordered table-condensed table-striped w-full">
                        ...
                        <tbody>
                          <tr v-for="item in series" :key="item.id">
                            ...
                            <td class="text-center">{{ item.cantidad_equipo }}</td>
                            ...
                            <td class="text-center space-x-2">
                              <Link
                                :href="route('admin.series.edit', item)"
                                method="get"
                              ...
                              <Link
                                ...
                                :href="route('admin.series.destroy', item)"
                                method="delete"
                      ...
                      <!-- Paginación -->
                      <div v-if="seriesData && seriesData.data">
                        <div class="mt-4 flex justify-center gap-2">
                          <button
                            v-if="seriesData.prev_page_url"
                            @click="changePage(seriesData.prev_page_url)"
                          ...
                          <button
                            v-if="seriesData.next_page_url"
                            @click="changePage(seriesData.next_page_url)"
                            class="px-4 py-2 rounded border bg-gray-100 text-gray-600 hover:bg-gray-200"
                          >
                            Siguiente
                          </button>
